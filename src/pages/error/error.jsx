    ...
    return (
        <Box m="20px" >
            ...
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 5 }} alignItems='center' justifyContent="center" >
                <p>Ocorreu um erro um erro desconhecido ao tentar executar sua solicitação. Entre em contato com o administrador do sistema ou tente novamente mais tarde.</p>
            </Grid>
        </Box>
    )
}
